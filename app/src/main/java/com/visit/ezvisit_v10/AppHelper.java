...
public class AppHelper {
    ...
    private static String user,name, number;
...
//    private static List<ItemToDisplay> mfaOptions;
     ...
     */
    private static final String userPoolId = "us-east-1_1pkiMiun4";

    /**
     * Add you app id
     */
    private static final String clientId = "22m8o528onhmkpq8bbtvk20hce";
     ...
     */
    private static final String clientSecret = "1hk7jstdq6op0ls7o21viv0h6j1uagutjp8r62h1vakaj3lidvc1";
...
//        mfaOptions = new ArrayList<ItemToDisplay>();
    ...
    public static String getCurrNumber() {
        return number;
    }

    public static void setNumber(String newUser) {
        number = newUser;
    }
